...
function AddList({setList}) {
    ...
    return(
        <div className='addForm' onSubmit={handleSubmit}>
            <input type="text" name="name" className='box1' placeholder="Enter your Name" ref={nameRef}/>
            <input type="text" name="event" className='box1' placeholder="Enter event type" ref={eventsRef}/>
            <input type="text" name="mobile" className='box1' placeholder="Enter mobile number" ref={mobileRef}/>
            <input type="text" name="place" className='box1' placeholder="Enter event's location" ref={placeRef}/>
